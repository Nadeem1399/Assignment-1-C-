...
namespace FundRaisingProceedsApp
{
    class FundRaisingProceedsApp
    {
        static void Main( )
        {
            ...
            const double WHOLESALE_CONST_PER_CASE = 100.00;
            ...
            WriteLine("{0,22}/n", "Granola Bar Sales");
            WriteLine("{0,-15} {1,10:d}", "Cases Sold:", casesSold);
            ...
            WriteLine();
            WriteLine("Net Proceeds:" + netProfit.ToString("C3", CultureInfo.CurrentCulture));
